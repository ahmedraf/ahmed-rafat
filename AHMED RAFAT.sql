...
Insert into AUDITORIUM (id,name,seats_no)values (7,'nour',15)
...
Select row_ from SEAT;
Select seat_number from SEAT;
Select name from AUDITORIUM;
Select empioyee_paid_id  from RESERVATION;
Select title from MOVIE;
Select director from MOVIE;
Select cast from MOVIE;
Select username from EMPLOYEE;
Select password from EMPLOYEE;
Select screening_id , empioyee_reserved from RESERVATION;
Select reservation_contact,paid  from RESERVATION;
Select PAID,ACTIVE from RESERVATION;
Select description from MOVIE;
...
Update EMPLOYEE set username='yassmen' where id=1;
Update movie set description ='action' where title ='vikings'
Update EMPLOYEE set  password ='ahmed5399' where   username='ahmed';
Update MOVIE set  title ='hulk' where   id=4;
Update RESERVATION_TYPE set  reservation_ty ='action' where   id=3;
Update SEAT set  row_ = 25  where auditorium_id =4;  


Delete  from SEAT where row_= 7
Delete  from AUDITORIUM  where name='nour'
Delete  from RESERVATION  where paid='f'
Delete  from RESERVATION_TYPE  where reservation_ty = 'ticket'
Delete  from MOVIE  where description = 'action'
